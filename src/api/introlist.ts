  ...
  return new Promise((resolve) => {
    resolve([
      ...
      },
      {
        ...
        image: '/resources/groups/动画组.png',
      },
      {
        title: `运维保障部`,
